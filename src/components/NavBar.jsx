        ...
        <div className="sticky top-0 z-1000 bg-[#fbf7f4] py-4 border-b border-gray-300">
            <div className='flex flex-row justify-between items-center gap-4 px-2 lg:px-16'>
                ...
                <div className='hidden lg:block'>
                    <a className='bg-[#00df72] px-8 py-4 text-xl rounded-md' href="https://drive.google.com/file/d/1FmA__Ei_5LrEheL8Hi9cWE750rsuBefh/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                        Resume
                    </a>
                </div>
                ...
                <div className='flex flex-col lg:hidden' onClick={() => setOpenMenu(!openMenu)}>
                    ...
                    <div className={`lg:hidden absolute flex flex-col justify-end duration-800 gap-2 bg-[#fbf7f4] rounded-md p-2 border border-gray-300 ${openMenu ? 'top-14 right-0' : '-top-80 right-0'}`}>
                        ...
                        <a className='bg-[#00df72] px-4 py-1 text-xl rounded-md text-center' href="https://drive.google.com/file/d/1FmA__Ei_5LrEheL8Hi9cWE750rsuBefh/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                            Resume
                        </a>
                    </div>
                </div>
