        ...
        <div className='max-w-[1600px] mx-auto px-4'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='flex gap-2 mb-2'>
                        ...
                        <div className='text-xl font-medium'>
                            Quickly find blood donors by blood group and location.
                        </div>
                    </div>
                    ...
                    <div className='flex gap-2 mb-2'>
                        <div><span className="text-green-500 text-3xl font-medium">✓</span></div>
                        <div className='text-xl font-medium'>
                            Create, track, and update blood donation requests securely.
                        </div>
                    </div>
                    ...
                    <div className='flex gap-2 mb-2'>
                        <div><span className="text-green-500 text-3xl font-medium">✓</span></div>
                        <div className='text-xl font-medium'>
                            Efficient list management with pagination and filters
                        </div>
                    </div>
            ...
            <div>
                <h3 className='text-2xl lg:text-3xl font-semibold my-12'>
                    <span className='border-b-2 border-[#00df72]'>
                        Main Technology Stack - BloodConnect
                    </span>
                </h3>
...
" alt="" />
            ...
            <div className="my-12 mx-4">
                ...
                <p className="text-lg text-justify">
                    Faced challenges with secure authentication, dynamic location filtering, and real-time data updates; solved through Firebase JWT auth, dependent dropdowns for districts/upazilas, and TanStack Query caching for optimized performance and smooth user experience.
                </p>
            </div>
            ...
            <div className="my-12 mx-4">
                ...
                <p className="text-lg text-justify">
                    Enable real-time chat for seamless roommate communication, add lifestyle-based search filters, introduce user and listing reviews with ratings, and develop mobile apps for Android and iOS for easy access anytime.
                </p>
            </div>
