        ...
        <div className='my-2'>
            <div className='flex flex-col lg:flex-row  justify-between items-center gap-4 m-2 p-2 border-2 border-[#33333330] rounded-md h-full'>
                <div className='flex-1 bg-white border-2 border-gray-100 rounded-md shadow-2xl'>
                    <img src="https://i.ibb.co/Rkm44Lkv/btobridge-home-picture.png" alt="" className='w-[320px] rounded-md' />
                </div>
                <div className='flex-1'>
                    ...
                    <p className='text-xl text-justify p-2'>A web app where businesses (users) can post their products for sale, browse by category, and make purchases — essentially bridging the gap between sellers and buyers in the business world.</p>
